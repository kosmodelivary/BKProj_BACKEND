...
<%@ taglib prefix="fn" uri="http://java.sun.com/jsp/jstl/functions" %>
    ...
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge"><!-- 추가 -->
    ...
    <!-- external css-->
    <link href="${pageContext.request.contextPath}/bootstrap/font-awesome/css/font-awesome.css" rel="stylesheet" />
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/bootstrap/css/zabuto_calendar.css">
    ...
    <script src="${pageContext.request.contextPath}/bootstrap/js/chart-master/Chart.js"></script>
